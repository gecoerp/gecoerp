...
from gecoerp.tools import (assertion_report, config, existing_tables,
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # gecoerp.service.wsgi_server.application
        ...
        with cls._lock:
            with gecoerp.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        gecoerp.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
    ...
    def init(self, db_name):
        ...
        self._db = gecoerp.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            has_unaccent = gecoerp.modules.db.has_unaccent(cr)
            if gecoerp.tools.config['unaccent'] and not has_unaccent:
                _logger.warning("The option --unaccent was given but no unaccent() function was found in database.")
            self.has_unaccent = gecoerp.tools.config['unaccent'] and has_unaccent
