...
from gecoerp import api, fields, models, SUPERUSER_ID, tools,  _
from gecoerp.exceptions import AccessError, UserError, ValidationError
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in gecoerp.modules.loading.
        if not self._context.get(MODULE_UNINSTALL_FLAG):
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by GECOERP
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement GECOERP many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by GECOERP
