...
BASE_VERSION = gecoerp.modules.load_information_from_description_file('base')['version']
...
class ir_cron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id, job_id):
        ...
        try:
            ...
            gecoerp.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', cron_name, server_action_id), depth=log_depth)
            start_time = False
        ...
        try:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    job_cr = db.cursor()
                    try:
                        registry = gecoerp.registry(db_name)
