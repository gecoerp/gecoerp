...
import gecoerp
from gecoerp import api, http, models, tools, SUPERUSER_ID
from gecoerp.exceptions import AccessDenied, AccessError
from gecoerp.http import request, STATIC_CACHE, content_disposition
from gecoerp.tools import pycompat, consteq
from gecoerp.tools.mimetypes import guess_mimetype
from gecoerp.modules.module import get_resource_path, get_module_path
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            if tools.config['test_enable'] and gecoerp.modules.module.current_test:
                installed.add(gecoerp.modules.module.current_test)
            mods = [''] + gecoerp.conf.server_wide_modules + sorted(installed)
