...
from gecoerp import api, models, tools
from gecoerp.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from gecoerp.addons.web.controllers.main import module_boot
