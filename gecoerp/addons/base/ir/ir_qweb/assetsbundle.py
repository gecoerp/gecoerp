...
from gecoerp import fields, tools, SUPERUSER_ID
from gecoerp.tools.pycompat import string_types, to_text
from gecoerp.http import request
from gecoerp.modules.module import get_resource_path
from gecoerp.addons.base.ir.ir_qweb.qweb import escape
import psycopg2
from gecoerp.tools import func, misc
        ...
        return """
            (function (message) {
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (typeof gecoerp === "undefined") return;

                    gecoerp.define("AssetsBundle.ErrorMessage", function (require) {
                        "use strict";
