...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        """
        gecoerp.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False)
    ...
    def test_noupdate(self):
        ...
        gecoerp.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False, context={'overwrite': True})
