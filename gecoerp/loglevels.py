...
def get_encodings(hint_encoding='utf-8'):
    warnings.warn(
        "Deprecated since GECOERP 18. Mostly nonsensical as the "
...
def ustr(value, hint_encoding='utf-8', errors='strict'):
    ...
    """
    warnings.warn(
        "Deprecated since GECOERP 18: ustr() is a garbage bag of weirdo fallbacks "
    ...
    # str subclasses such as `gecoerp.tools.unquote`
