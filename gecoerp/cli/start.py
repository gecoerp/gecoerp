...
from gecoerp.modules.module import get_module_root, MANIFEST_NAMES
from gecoerp.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the gecoerp server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            gecoerp.tools.config['init']['base'] = True
