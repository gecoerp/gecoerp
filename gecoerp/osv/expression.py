...
Gecoerp will use the SQL function 'unaccent' when available for the
...
import gecoerp.modules
from gecoerp.exceptions import MissingError
from gecoerp.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from gecoerp.tools import Query, SQL, get_lang
from gecoerp.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return gecoerp.modules.registry.Registry(cr.dbname).unaccent
