...
from gecoerp.tools import frozendict, classproperty
...
def constrains(*args):
    ...
    Should raise :class:`~gecoerp.exceptions.ValidationError` if the
    validation failed.
...
def one(method):
    """ Decorate a record-style method where ``self`` is expected to be a
        ...
        .. deprecated:: 9.0
            ...
            is a single record with :meth:`~gecoerp.models.Model.ensure_one`.
    """
...
from gecoerp.exceptions import UserError, AccessError, MissingError
