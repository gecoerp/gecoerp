...
"""The GECOERP API module defines GECOERP Environments and method decorators.
...
from gecoerp.tools.misc import StackMap

import typing
if typing.TYPE_CHECKING:
    from collections.abc import Callable
    from gecoerp.sql_db import BaseCursor
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~gecoerp.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~gecoerp.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/gecoerp/gecoerp/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~gecoerp.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~gecoerp.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~gecoerp.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~gecoerp.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in gecoerp.tools.file_open_temporary_directory)
