...
if typing.TYPE_CHECKING:
    ...
    from gecoerp.api import Self, ValuesType, IdType
    ...
    def __new__(meta, name, bases, attrs):
        ...
        if attrs.get('_register', True):
            ...
            if '_module' not in attrs:
                ...
                assert module.startswith('gecoerp.addons.'), \
                    f"Invalid import of {module}.{name}, it should start with 'gecoerp.addons'."
...
class BaseModel(metaclass=MetaModel):
    """Base class for GECOERP models.

    GECOERP models are created by inheriting one of the following:
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    the :attr:`~gecoerp.models.BaseModel._register` attribute may be set to False.
    """
    ...
    If set to ``False``, override :meth:`~gecoerp.models.BaseModel.init`
    ...
    .. tip:: To create a model without any table, inherit
            from :class:`~gecoerp.models.AbstractModel`.
    """
    ...
    _module = None                      #: the model's module (in the GECOERP sense)
    ...
    .. warning::
      ...
      :attr:`~gecoerp.models.Model._inherits`-ed models, the inherited field will
    ...
    def load(self, fields, data):
        ...
        for field_path in fields:
            ...
            for field_name in field_path:
                ...
                if isinstance(model_fields.get(field_name), gecoerp.fields.One2many):
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~gecoerp.api.depends` and
        context-dependent using :attr:`~gecoerp.api.depends_context`.
        """
        if self._rec_name:
        ...
        if field.type in ('datetime', 'date') or (field.type == 'properties' and granularity):
            ...
            if granularity == 'week':
                ...
                if granularity == 'day_of_week':
                    """
                    formula: ((7 - first_day_of_week_in_gecoerp) + result_from_SQL) %  --> 0 based first day of week
                                    week start on
                                monday   sunday    sat
                                  1     |  7    |  6   <-- first day of week in gecoerp
                           SQL | -----------------------
                    Monday  1  |  0     |  1    |  2
                    tuesday 2  |  1     |  2    |  3
                    wed     3  |  2     |  3    |  4
    ...
    def _read_group_fill_temporal(self, data, groupby, annoted_aggregates,
        ...
        if fill_from:
            fill_from = gecoerp.fields.Datetime.to_datetime(fill_from) if isinstance(fill_from, datetime.datetime) else gecoerp.fields.Date.to_date(fill_from)
        ...
        if fill_to:
            fill_to = gecoerp.fields.Datetime.to_datetime(fill_to) if isinstance(fill_to, datetime.datetime) else gecoerp.fields.Date.to_date(fill_to)
    ...
    def _field_to_sql(self, alias: str, fname: str, query: (Query | None) = None, flush: bool = True) -> SQL:
        ...
        result to make method :meth:`~gecoerp.api.Environment.execute_query` flush
    ...
    def _check_company(self, fnames=None):
        ...
        :raises UserError: if the `company_id` of the value of any field is not
            ...
            :class:`~gecoerp.addons.base.models.res_company`).

        For :class:`~gecoerp.addons.base.models.res_users` relational fields,
    ...
    def unlink(self):
        ...
        from gecoerp.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
    ...
    def write(self, vals: ValuesType) -> typing.Literal[True]:
        ...
        * For numeric fields (:class:`~gecoerp.fields.Integer`,
          :class:`~gecoerp.fields.Float`) the value should be of the
          corresponding type
        * For :class:`~gecoerp.fields.Boolean`, the value should be a
          :class:`python:bool`
        * For :class:`~gecoerp.fields.Selection`, the value should match the
          selection values (generally :class:`python:str`, sometimes
          :class:`python:int`)
        * For :class:`~gecoerp.fields.Many2one`, the value should be the
          database identifier of the record to set
        * The expected value of a :class:`~gecoerp.fields.One2many` or
          :class:`~gecoerp.fields.Many2many` relational field is a list of
          :class:`~gecoerp.fields.Command` that manipulate the relation the
          implement. There are a total of 7 commands:
          :meth:`~gecoerp.fields.Command.create`,
          :meth:`~gecoerp.fields.Command.update`,
          :meth:`~gecoerp.fields.Command.delete`,
          :meth:`~gecoerp.fields.Command.unlink`,
          :meth:`~gecoerp.fields.Command.link`,
          :meth:`~gecoerp.fields.Command.clear`, and
          :meth:`~gecoerp.fields.Command.set`.
        * For :class:`~gecoerp.fields.Date` and `~gecoerp.fields.Datetime`,
          ...
          .. warning::
            ...
            :const:`gecoerp.tools.misc.DEFAULT_SERVER_DATE_FORMAT` and
            :const:`gecoerp.tools.misc.DEFAULT_SERVER_DATETIME_FORMAT`
    ...
    def ensure_one(self) -> Self:
        ...
        :raise gecoerp.exceptions.ValueError: ``len(self) != 1``
        """
        try:
    ...
    def with_env(self, env: api.Environment) -> Self:
        ...
        :param env:
        :type env: :class:`~gecoerp.api.Environment`
    ...
    def with_company(self, company) -> Self:
        ...
        :type company: :class:`~gecoerp.addons.base.models.res_company` or int
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted GECOERP models.

    GECOERP models are created by inheriting from this class::
