...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(gecoerp.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param gecoerp.api.Environment env: The environment where the registry
