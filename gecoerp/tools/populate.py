...
This tool provides utilities to duplicate records across models in GECOERP, while maintaining referential integrity,
...
from gecoerp.tools.sql import SQL
from gecoerp.fields import Field, Many2one
from gecoerp.models import Model
