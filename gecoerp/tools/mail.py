...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/gecoerp/gecoerp/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # gecoerp, gmail and outlook automatic signature wrapper
    is_signature_wrapper = 'gecoerp_signature_wrapper' in el_class or 'gmail_signature' in el_class or el_id == "Signature"
...
def plaintext2html(text, container_tag=None, with_paragraph=True):
    ...
    html entities, using :func:`~gecoerp.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within gecoerp, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within gecoerp, this assumption is certain to fall
