...
from gecoerp.loglevels import get_encodings, ustr, exception_to_unicode     # noqa
...
def file_open(name, mode="r", subdir='addons', pathinfo=False):
    ...
    """
    import gecoerp.modules as addons
...
def scan_languages():
    ...
    :rtype: [(str, unicode)]
    """
    csvpath = gecoerp.modules.module.get_resource_path('base', 'res', 'res.lang.csv')
    try:
