...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching GECOERP.
    """
    name = 'traces_sync'
    ...
    def end(self):
        ...
        try:
            ...
            if self.db:
                ...
                from gecoerp.sql_db import db_connect  # only import from gecoerp if/when needed.
