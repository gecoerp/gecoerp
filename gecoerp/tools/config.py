...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        self.options = {
            'admin_passwd': 'admin',
            'csv_internal_sep': ',',
            'publisher_warranty_url': 'http://services.gecoerp.com/publisher-warranty/',
            'reportgz': False,
            'root_path': None,
        ...
        temp_tests_dir = os.path.join(tempfile.gettempdir(), 'gecoerp_tests')
    ...
    def parse_config(self, args: list[str] | None = None, *, setup_logging: bool | None = None) -> None:
        ...
        if setup_logging is not False:
            ...
            if setup_logging is None:
                warnings.warn(
                    "As of GECOERP 18, it's recommended to specify whether"
                    " you want GECOERP to setup its own logging (or want to"
                    " handle it yourself)",
