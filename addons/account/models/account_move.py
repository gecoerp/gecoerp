...
from gecoerp.exceptions import RedirectWarning, UserError, ValidationError
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals):
        ...
        if context.get('apply_taxes') and vals.get('tax_ids'):
            # Get ids from triplets : https://www.gecoerp.com/documentation/10.0/reference/orm.html#gecoerp.models.Model.write
