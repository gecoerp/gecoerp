...
The GECOERP <a href="https://www.gecoerp.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. GECOERP's user interface is designed with productivity in mind.
...
accounting; GECOERP has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

GECOERP supports multiple currencies, multiple users with different access rights,
