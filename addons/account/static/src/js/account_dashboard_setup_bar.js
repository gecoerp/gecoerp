gecoerp.define('account.dashboard_setup_bar', function (require) {
"use strict";
...
var AccountSetupBarController = KanbanController.extend({
    ...
    **/
    _triggerCompanyButtonAction: function (gecoerpEvent) {
        var self = this
        if (gecoerpEvent.data.rpc_method !== undefined) {
            self._rpc({
                    model: 'res.company',
                    method: gecoerpEvent.data.rpc_method,
                    args: [],
                })
                .then(
                    function(rslt_action) {
                        if (rslt_action !== undefined) {
                            self.do_action(rslt_action, {
                                action_context: gecoerpEvent.data.context,
                                on_close: function () {
