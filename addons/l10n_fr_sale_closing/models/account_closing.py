...
from gecoerp import models, api, fields
from gecoerp.fields import Datetime as FieldDateTime
...
class AccountClosing(models.Model):
    ...
    def _interval_dates(self, frequency, company):
        ...
        @return {dict} the theoretical date from which account move lines are fetched.
            ...
            the dates are in their GECOERP Database string representation
        """
