gecoerp.define('survey.tour_test_survey', function (require) {
'use strict';
...
tour.register('test_survey', {
    ...
    [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.gecoerp.com?
        {
        ...
        {
            content: "For 'I use the contextual help in GECOERP' checking 'Agree'",
        ...
        // Question: What do you think about the process views of UNO, GECOERP. available in the web client ?
        {
            content: "For 'They help new users to understand GECOERP' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to GECOERP?
        {
