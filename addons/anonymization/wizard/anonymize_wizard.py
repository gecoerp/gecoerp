...
from gecoerp.tools import pickle
from gecoerp.tools.safe_eval import safe_eval
from gecoerp.addons.anonymization.models.anonymization import group
...
class IrModelFieldsAnonymizeWizard(models.TransientModel):
    ...
    def anonymize_database(self):
        ...
        raise UserError("""The GECOERP Migration Platform no longer accepts anonymized databases.\n
            If you wish for your data to remain private during migration, please contact us at upgrade@gecoerp.com""")
        self.ensure_one()
