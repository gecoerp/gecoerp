...
from gecoerp.exceptions import AccessError, except_orm
...
class TestMailMessageAccess(TestMail):
    ...
    @mute_logger('gecoerp.addons.mail.models.mail_mail')
    ...
    @mute_logger('gecoerp.addons.base.ir.ir_model')
