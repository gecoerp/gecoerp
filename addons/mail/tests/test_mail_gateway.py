...
from gecoerp.addons.mail.tests.common import TestMail
from gecoerp.tools import mute_logger
...
From: Anon <anon@gecoerp.com>
To: anon@gmail.com
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@gecoerp.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@gecoerp.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@gecoerp.com>
Content-Type: multipart/mixed;
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@gecoerp.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@gecoerp.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@gecoerp.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=gecoerp.com
Return-Path: <soup@gecoerp.com>
Received: from mail2.gecoerp.com (mail2.gecoerp.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@gecoerp.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.gecoerp.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@gecoerp.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=gecoerp.com; s=mail;
...
To: what@gecoerp.com
From: Soup <soup@gecoerp.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@gecoerp.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.gecoerp.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.gecoerp.com">http://www.gecoerp.com</a> </pre>
  </body>
</html>
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.gecoerp.com">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
class TestMailgateway(TestMail):
    ...
    @mute_logger('gecoerp.addons.mail.models.mail_thread')
    ...
    @mute_logger('gecoerp.addons.mail.models.mail_thread', 'gecoerp.models')
    ...
    @mute_logger('gecoerp.addons.mail.models.mail_thread', 'gecoerp.models', 'gecoerp.addons.mail.models.mail_mail')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by gecoerp should update thread accordingly """
    ...
    def test_message_process_model_res_id(self):
        ...
        # GECOERP 10 update: compat mode has been removed and should not work anymore
        ...
        # GECOERP 10 update: compat mode has been removed and should not work anymore and does not depend from hostname
        self.assertRaises(ValueError,
                          self.format_and_process,
                          MAIL_TEMPLATE, email_from='other5@gmail.com',
    ...
    def test_forward_parent_id(self):
        ...
        # tmp
        from gecoerp.addons.mail.tests.test_mail_model import MailTest
