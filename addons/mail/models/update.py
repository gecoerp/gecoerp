...
from gecoerp import api, release, SUPERUSER_ID
from gecoerp.exceptions import UserError
from gecoerp.models import AbstractModel
from gecoerp.tools.translate import _
from gecoerp.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to GECOERP's publisher warranty server to check the
