...
from gecoerp import _, api, exceptions, fields, models, modules
from gecoerp.tools import pycompat
from gecoerp.addons.base.res.res_users import is_selection_groups
