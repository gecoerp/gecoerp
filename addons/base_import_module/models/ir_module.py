...
from gecoerp.modules import load_information_from_description_file
from gecoerp.tools import convert_file, exception_to_unicode, pycompat
from gecoerp.tools.osutil import tempdir
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import gecoerp.modules.module as module
                try:
