...
from gecoerp import http, models, fields, _
from gecoerp.http import request
from gecoerp.tools import pycompat, OrderedSet
from gecoerp.addons.http_routing.models.ir_http import slug, _guess_mimetype
from gecoerp.addons.web.controllers.main import WebClient, Binary
from gecoerp.addons.portal.controllers.portal import pager as portal_pager
from gecoerp.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': gecoerp.service.common.exp_version()
        }
