gecoerp.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = Animation.extend({
    ...
    start: function () {
        ...
        // integrated with GECOERP (this refactoring should be done in master).
 ...
 *
 * This should be removed in a future gecoerp snippets refactoring.
 */
