...
from gecoerp.exceptions import UserError, AccessError, ValidationError
from gecoerp.tools import float_compare
...
class HolidaysType(models.Model):
    ...
    categ_id = fields.Many2one('calendar.event.type', string='Meeting Type',
        help='Once a leave is validated, GECOERP will create a corresponding meeting of this type in the calendar.')
