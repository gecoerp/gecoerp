...
from gecoerp.addons.hw_proxy.controllers import main as hw_proxy
...
<html>
    <head>
        <title>GECOERP's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.gecoerp.com/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='https://www.gecoerp.com/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/gecoerp/ --git-dir=/home/pi/gecoerp/.git log -1", shell=True).decode('utf-8').replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/gecoerp/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
