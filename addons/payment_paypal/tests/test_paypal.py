...
from gecoerp.addons.payment.tests.common import PaymentAcquirerCommon
from gecoerp.addons.payment_paypal.controllers.main import PaypalController
...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.paypal.write({'paypal_email_account': 'tde+paypal-facilitator@gecoerp.com', 'fees_active': False})
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@gecoerp.com',
    ...
    @mute_logger('gecoerp.addons.payment_paypal.models.payment', 'ValidationError')
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@gecoerp.com',
