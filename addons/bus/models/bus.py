...
import gecoerp
from gecoerp import api, fields, models, SUPERUSER_ID
from gecoerp.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class ImBus(models.Model):
    ...
    def sendmany(self, notifications):
        ...
        if channels:
            ...
            def notify():
                with gecoerp.sql_db.db_connect('postgres').cursor() as cr:
...
dispatch = None
if not gecoerp.multi_process or gecoerp.evented:
