gecoerp.define('pos_mercury.pos_mercury', function (require) {
"use strict";
...
PaymentScreenWidget.include({
    // How long we wait for the gecoerp server to deliver the response of
        ...
        rpc.query({
            ...
            .then(function (data) {
                ...
                if (data === "internal error") {
                    def.resolve({
                        message: _t("GECOERP error while processing transaction.")
                    });
                    return;
                }
