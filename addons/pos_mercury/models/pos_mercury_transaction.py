...
from gecoerp import models, api, service
from gecoerp.tools.translate import _
from gecoerp.exceptions import UserError
from gecoerp.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "GECOERP " + service.common.exp_version()['server_version']
