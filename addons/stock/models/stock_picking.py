...
from gecoerp.tools import DEFAULT_SERVER_DATETIME_FORMAT
from gecoerp.tools.float_utils import float_compare, float_is_zero, float_round
from gecoerp.exceptions import UserError
from gecoerp.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, GECOERP will show which products are reserved (lot/serial number, source location, source package).")
