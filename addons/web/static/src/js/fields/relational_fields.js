gecoerp.define('web.relational_fields', function (require) {
"use strict";
...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {GECOERPEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {GECOERPEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {GECOERPEvent|MouseEvent} ev this event comes either from the 'Add
