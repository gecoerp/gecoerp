gecoerp.define('web.mixins', function (require) {
"use strict";
...
function GECOERPEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
GECOERPEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

GECOERPEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new GECOERPEvent(this, name, info);
...
gecoerp.define('web.ServicesMixin', function (require) {
"use strict";
