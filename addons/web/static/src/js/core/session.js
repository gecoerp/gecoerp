...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    init: function (parent, origin, options) {
        ...
        options = options || {};
        this.module_list = (options.modules && options.modules.slice()) || (window.gecoerp._modules && window.gecoerp._modules.slice()) || [];
        this.server = null;
    ...
    session_reload: function () {
        var result = _.extend({}, window.gecoerp.session_info);
        delete result.session_id;
