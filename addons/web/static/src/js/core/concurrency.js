gecoerp.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in GECOERP.
 *
 * The basic concurrency primitives in GECOERP JS are the callback, and the
...
return {
    ...
    /**
     * A (GECOERP) mutex is a primitive for serializing computations.  This is
