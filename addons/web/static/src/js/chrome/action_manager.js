gecoerp.define('web.ActionManager', function (require) {
"use strict";

/**
 * ActionManager
 *
 * The action manager is quite important: it makes sure that actions (the GECOERP
...
var ActionManager = Widget.extend({
    ...
    start: function() {
        ...
        core.bus.on('DOM_updated', this, function() {
            ...
            if (this.inner_action && !$('.dialog').length) {
