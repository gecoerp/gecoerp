gecoerp.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. GECOERP JS views are the
 ...
 * the word 'view' has historical significance in GECOERP code, so we replaced the
...
gecoerp.define('web.viewUtils', function () {
"use strict";
