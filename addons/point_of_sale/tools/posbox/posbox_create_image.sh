...
VERSION=11.0
REPO=https://github.com/gecoerp/gecoerp.git
...
CLONE_DIR="${OVERWRITE_FILES_BEFORE_INIT_DIR}/home/pi/gecoerp"
...
gecoerp/
gecoerp-bin" | tee --append .git/info/sparse-checkout > /dev/null
