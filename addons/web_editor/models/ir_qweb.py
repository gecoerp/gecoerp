...
Also, adds methods to convert values back to GECOERP models.
"""
...
from gecoerp import api, models, fields
from gecoerp.tools import ustr, pycompat
from gecoerp.tools import html_escape as escape
from gecoerp.addons.base.ir import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = gecoerp.modules.get_module_resource(
