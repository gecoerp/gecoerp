gecoerp.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.gecoerp[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.gecoerp[callback + '_editor']) {
                window.top.gecoerp[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.gecoerp[callback + '_downup']) {
                    window.top.gecoerp[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
gecoerp.define('web_editor.IframeRoot.instance', function (require) {
'use strict';
...
gecoerp.define('web_editor.IframeRoot', function (require) {
'use strict';
