...
from gecoerp.addons.payment_authorize.controllers.main import AuthorizeController
from gecoerp.tools import mute_logger


@gecoerp.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('gecoerp.addons.payment_authorize.models.payment', 'ValidationError')
    ...
    def test_30_authorize_s2s(self):
        ...
        # add credential
        # FIXME: put this test in master-nightly on gecoerp/gecoerp + create sandbox account
        authorize.write({
