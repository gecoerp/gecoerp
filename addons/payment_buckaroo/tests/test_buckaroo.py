...
from gecoerp.addons.payment_buckaroo.controllers.main import BuckarooController
from gecoerp.tools import mute_logger


@gecoerp.tests.common.at_install(False)
@gecoerp.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('gecoerp.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@gecoerp.com',
