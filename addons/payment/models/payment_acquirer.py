...
from gecoerp import api, exceptions, fields, models, _
from gecoerp.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from gecoerp.addons.base.module import module
...
class PaymentAcquirer(models.Model):
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from GECOERP, when the delivery is completed.")
