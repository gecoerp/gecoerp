...
from gecoerp.addons.event.tests.common import TestEventCommon
from gecoerp.exceptions import ValidationError, UserError, AccessError
from gecoerp.tools import mute_logger
from gecoerp.fields import Datetime
try:
...
class TestEventFlow(TestEventCommon):
    ...
    @mute_logger('gecoerp.addons.base.ir.ir_model', 'gecoerp.models')
    ...
    def test_event_date_range(self):
        self.patcher = patch('gecoerp.addons.event.models.event.fields.Datetime', wraps=Datetime)
