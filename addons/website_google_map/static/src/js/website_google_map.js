function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('gecoerp-google-map'), {
        zoom: 1,
    ...
    if (gecoerp_partner_data){ /* gecoerp_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < gecoerp_partner_data.counter; i++) {
            set_marker(gecoerp_partner_data.partners[i]);
        }
