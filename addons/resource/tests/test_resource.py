...
from gecoerp.fields import Date, Datetime
from gecoerp.addons.resource.models.resource import to_naive_utc, to_naive_user_tz
from gecoerp.addons.resource.tests.common import TestResourceCommon
