...
from gecoerp.tests.common import TransactionCase, can_import
from gecoerp.modules.module import get_module_resource
from gecoerp.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('gecoerp.addons.base_import.models.base_import')
