gecoerp.define('website_sale.cart', function (require) {
    "use strict";
...
gecoerp.define('website_sale.website_sale_category', function (require) {
    "use strict";
...
gecoerp.define('website_sale.website_sale', function (require) {
    "use strict";
    ...
    require("website.content.zoomgecoerp");
    var _t = core._t;
    ...
    $('.oe_website_sale').each(function () {
        ...
        function update_product_image(event_source, product_id) {
            ...
            if ($img.data('zoomGECOERP') !== undefined) {
                $img.data('zoomGECOERP').isReady = false;
            }
        }
    ...
    if (config.device.size_class > config.device.SIZES.XS) {
        $('.ecom-zoomable img[data-zoom]').zoomGECOERP({ attach: '#o-carousel-product'});
    }
});
