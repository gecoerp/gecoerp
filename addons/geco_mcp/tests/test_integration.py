...
from odoo.addons.geco_mcp.core.tool import get_tool_index
from odoo.addons.geco_mcp.tools import protocol
from odoo.addons.geco_mcp.tools.encoder import encode_request, encode_response
...
class TestMcpIntegration(common.TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.key_model = cls.env['geco_mcp.key']
        cls.tool_model = cls.env['geco_mcp.tool']
        cls.session_model = cls.env['geco_mcp.session']
        cls.log_model = cls.env['geco_mcp.log']
        cls.notification_model = cls.env['geco_mcp.notification']
