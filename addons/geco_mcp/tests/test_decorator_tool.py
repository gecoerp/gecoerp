...
from odoo.addons.geco_mcp.core import tool as core_tool
...
class TestMcpDecoratorTool(common.TransactionCase):
    ...
    def setUp(self):
        super().setUp()
        self.env.registry._geco_mcp_method_cache = dict(TEST_REGISTRY)
    ...
    def test_scanner_finds_decorated_method_on_live_registry(self):
        ...
        mixin_cls = type(self.env['geco_mcp.mixin'])
        ...
        self.assertEqual(entry['model'], 'geco_mcp.mixin')
    ...
    def test_recordset_result_serialized_via_record_encoder(self):
        ...
        self.env.registry._geco_mcp_method_cache['mcp_test_record'] = {
            'kind': 'method',
            'model': 'res.partner',
