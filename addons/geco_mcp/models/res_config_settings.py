...
class ResConfigSettings(models.TransientModel):
    ...
    mcp_session_timeout = fields.Integer(
        ...
        config_parameter='geco_mcp.session_timeout_hours',
        default=24,
    ...
    mcp_log_retention = fields.Integer(
        ...
        config_parameter='geco_mcp.log_autovacuum_days',
        default=30,
    ...
    mcp_rate_limit_requests = fields.Integer(
        ...
        config_parameter='geco_mcp.rate_limit_requests',
        default=60,
    ...
    mcp_annotate_messages = fields.Boolean(
        ...
        config_parameter='geco_mcp.annotate_messages',
        default=True,
        help=(
