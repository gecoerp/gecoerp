...
const LAST_TOOL_STORAGE_KEY = "geco_mcp.playground.last_tool";

export class Playground extends Component {
    static template = "geco_mcp.Playground";
    ...
    setup() {
        ...
        onMounted(() => {
            const search = this.rootRef.el?.querySelector(
                ".o_geco_mcp_list input[type=search]"
            );
            search?.focus();
        });
        onWillUnmount(() => {
...
registry.category("actions").add("geco_mcp.playground", Playground);
